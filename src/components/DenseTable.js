...
export default function DenseTable() {
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      const newSelecteds = rows.map((n) => n['Short Name']);
          ...
          >
            ...
            <TableBody>
              ...
              {stableSort(rows, getComparator(order, orderBy))
                ...
                .map((row, index) => {
                  const isItemSelected = isSelected(row['Short Name']);
                  const labelId = `enhanced-table-checkbox-${index}`;

                  return (
                    <TableRow
                      hover
                      onClick={(event) => handleClick(event, row['Short Name'])}
                      role="checkbox"
                    ...
                    >
                      ...
                      <TableCell align="right">{row.MSCI}</TableCell>
                      <TableCell align="right">{row['S&P']}</TableCell>
                      <TableCell align="right">{row.ISS}</TableCell>
